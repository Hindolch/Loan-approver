...
def continuous_deployment_pipeline():
    ...
    trained_model = loan_approval_pipeline()  # No need for is_promoted return value anymore

    # (Re)deploy the trained model
    mlflow_model_deployer_step(model_name="loan_approval_model", workers=3, deploy_decision=True, model=trained_model)
