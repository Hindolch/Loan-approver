...
class MinMaxScalingTransformation(FeatureEngineeringStrategy):
...
# This strategy applies Label-encoding to categorical features having more than one type, converting them into numerical vectors.
